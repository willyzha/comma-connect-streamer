...
def GetAvailableSegments():
  ...
  url = f"https://api.commadotai.com/v1/devices/ce4fce297fea9df0/routes_segments?start=0&end={millis}"
...
def GetSegments(start_time=None, end_time=None, check_db=CHECK_DATABASE, db_instance=None):
  ...
  url = f"https://api.commadotai.com/v1/devices/ce4fce297fea9df0/routes_segments?start={start_millis}&end={end_millis}"
  response = s.get(url, headers={'Authorization': JWT_KEY})
